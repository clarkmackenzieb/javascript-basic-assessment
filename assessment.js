...
var rainbowColors = "red orange yellow green blue indigo violet".split(" ");
...
*/
	...
	function outside(temp, humi, cloudy){
		if(temp > 80 && humi > 40){
		...
		else if(temp > 80 && humi < 40 && cloudy < 20){
			return "I'm literally in the desert";
		}
		else if(temp > 80 || humi > 50 || cloudy > 50){
...
// CAUSE I AINT NO CALLABACK GIIIIIIRL
